...
public class Chassiss extends Spares {
    ...
    public Chassiss(final Integer id, final int serialNumber, final int price, final CategoryEnum detailCategory, final int amount, final int numberof) {
        super(id, serialNumber, price, detailCategory, amount);
